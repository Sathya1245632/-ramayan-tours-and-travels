        ...
        >
            <div className="flex items-center gap-3 px-4 py-3">
                ...
                <div className="hidden sm:flex flex-col items-start px-1">
                    <span className="text-white text-sm font-bold leading-none whitespace-nowrap">Book Now on WhatsApp</span>
                    <span className="text-white/80 text-[10px] sm:text-xs whitespace-nowrap">+91 7639661626</span>
                </div>
                <span className="sm:hidden text-white text-xs font-bold whitespace-nowrap">Book Now</span>
            </div>
        </a>
    );
}
